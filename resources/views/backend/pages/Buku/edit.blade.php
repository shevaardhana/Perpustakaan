...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Form Update Buku</h1>
    </div>
            ...
            <form action="{{ route('buku.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="deskripsi"
                        id="editor"
                        class="form-control
                        @error('deskripsi') is-invalid @enderror">{{ old('deskripsi') ? old('deskripsi') : $item->deskripsi }}</textarea>
                ...
                <div class="form-group">
                    ...
                    class="form-control"
                    name="tanggal_terbit"
                    value="{{ old('tanggal_terbit') ? old('tanggal_terbit') : $item->tanggal_terbit}}" required>
                </div>

                <div class="form-group">
                    <label for="stock" class="form-control-label">Stock</label>
                    <input type="number"
                    name="stock" value="{{ old('stock') ? old('stock') : $item->stock }}"
